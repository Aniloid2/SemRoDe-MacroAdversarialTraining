...
from textattack.search_methods import GreedyWordSwapWIR, GreedySearch, BeamSearch,AlzantotGeneticAlgorithm,ParticleSwarmOptimization
...
class TextFoolerPSO(AttackRecipe):
