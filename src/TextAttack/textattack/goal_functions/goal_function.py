...
class GoalFunction(ReprMixin, ABC):
    ...
    def __init__(
        ...
        self.query_budget_size = query_budget
    ...
    def init_attack_example(self, attacked_text, ground_truth_output):
        ...
        # self.query_budget = self.query_budget_size * attacked_text.num_words
        # self.query_budget
        # print ('attacked text words',50,attacked_text.num_words)
        # sys.exit()
        # self.query_budget_size

        # self.query_budget_size = float("inf")
        # if self.query_budget_size != float("inf"):
        #     self.query_budget = self.query_budget * attacked_text.num_words
        # elif self.query_budget_size == None:
        #     self.query_budget  = None
        # else:
        #     self.query_budget = self.query_budget_size


        # self.query_budget_No = self.query_budget
        # if self.query_budget != float("inf"):
        #     self.query_budget = self.query_budget * attacked_text.num_words
        # elif self.query_budget == None:
        #     self.query_budget  = None
        # else:
        #     self.query_budget = self.query_budget_size
        ...
        # print ('size', self.query_budget_size  ,attacked_text.num_words)
        # print ('query budget sample',self.query_budget)
