...
class MnliProcessor(DataProcessor):
    ...
    def get_adv_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "adv_train.tsv")), "adv_train")
    ...
    def get_adv_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "adv_dev_matched.tsv")), "adv_dev_matched")
