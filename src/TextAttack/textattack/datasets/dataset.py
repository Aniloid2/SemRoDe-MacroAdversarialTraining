...
class Dataset(torch.utils.data.Dataset):
    ...
    def _format_as_dict(self, example):
        ...
        # print ('input cols',self.input_columns)
    ...
    def filter_by_labels_(self, labels_to_keep):
        ...
        # print ('label names',labels_to_keep)
        # print ('first example',self._dataset[0])
        # self._dataset = self._dataset.filter(lambda x: x[1] in labels_to_keep)
        # print ('start dataset',self._dataset)
        self._dataset = list(filter(lambda x: x[1] in labels_to_keep, self._dataset))

        # print ('data',self._dataset[0])
