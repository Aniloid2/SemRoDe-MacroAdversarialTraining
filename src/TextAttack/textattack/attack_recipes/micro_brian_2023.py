...
from textattack.search_methods import GreedyWordSwapWIR, GreedySearch, BeamSearch, MicroSearch,MicroSearchBW
from textattack.transformations import WordSwapEmbedding,WordSwapMicro,WordSwapMicroBW
import math
...
class MicroBrian2023(AttackRecipe):
    ...
    def build(model_wrapper,max_modification_rate=None,cos_sim=0.5,sem_sim=0.8,no_cand=50):
        ...
        transformation = WordSwapMicroBW(model_wrapper, top_n=50)
        #
        ...
        # stopwords=None
        # fmt: on
        # constraints = [TokenizerAlignment(model_wrapper.tokenizer),RepeatModification(), StopwordModification(stopwords=stopwords)]#,MinWordLength(min_length = 2)]
        constraints = [TokenizerAlignment(model_wrapper.tokenizer),RepeatModification()]
        ...
        #
        goal_function = UntargetedClassification(model_wrapper,query_budget = 1000000)
        #
        # Greedily swap words with "Word Importance Ranking".
        #
        # search_method = GreedyWordSwapWIR(wir_method="delete")
        # search_method = GreedySearch( )
        # search_method = BeamSearch(beam_width=50)
        search_method = MicroSearchBW(beam_width=50)
