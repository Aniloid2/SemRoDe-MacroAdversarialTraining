...
from textattack.goal_functions import UntargetedClassification,TargetedClassification,MaximizeLossGoalFunction
...
class TextFoolerMaxLoss(AttackRecipe):
    ...
    def build(model_wrapper,max_modification_rate=None,cos_sim=0.5,sem_sim=0.8,no_cand=50):
        ...
        #
        # goal_function = UntargetedClassification(model_wrapper=model_wrapper,query_budget = no_cand)
        #
        goal_function = MaximizeLossGoalFunction(model_wrapper=model_wrapper,query_budget = no_cand)
        #
