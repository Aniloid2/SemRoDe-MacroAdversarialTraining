...
def extract_dictionary(model_wrapper,name_embedding = 'glove'):
        import json
        import nltk
        ...
        if name_embedding == 'glove':
            ...
            bert_vocab = model_wrapper.tokenizer.vocab
        ...
        elif name_embedding == 'counter_vector':
            
            nbr_file = '/home/brianformento/security_project/defense/attention_align/FGPM/data/counter-fitted-vectors.txt'
            ...
            loaded = loadGloveModel(nbr_file)
            
            return loaded.keys(), loaded

def filter_dictionary(dictionary = None):
        if dictionary == None:
